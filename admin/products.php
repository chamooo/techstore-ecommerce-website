...
<div id="wrapper">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Всі товари</h1>
            <br>
            <!-- DataTales Example -->
            <?php
            if(empty($_GET)) {
                ...
                switch ($_GET['page']) {
                    case 'edit':
                        require($_SERVER['DOCUMENT_ROOT'] . '/admin/modules/products/edit-page.php');
                        break;
                    case 'delete':
                        require($_SERVER['DOCUMENT_ROOT'] . '/admin/modules/products/delete.php');
                        break;
                    case 'add':
                        require($_SERVER['DOCUMENT_ROOT'] . '/admin/modules/products/create-page.php');
                        break;
                    default:
                        break;
                }
